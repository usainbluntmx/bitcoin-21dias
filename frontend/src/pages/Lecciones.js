        ...
        <div className="min-h-screen bg-gray-950 px-4 py-8">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-400 mb-4">21 lecciones · ~5 min cada una</p>
                ...
                {semanas.map((semana) => (
                    <div key={semana.numero} className="mb-10">
                        <div className={`bg-gradient-to-r ${semana.color} rounded-2xl p-4 mb-4 flex items-center justify-between`}>
                            <div>
                                <p className="text-white text-xs font-bold uppercase tracking-wider opacity-80">
                                    Semana {semana.numero}
                                </p>
                                <h2 className="text-white text-xl font-black">{semana.titulo}</h2>
                                <p className="text-white opacity-80 text-sm">{semana.descripcion}</p>
                            </div>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`flex items-center gap-4 p-4 rounded-xl border-2 text-left transition-all ${completada
                                                ? "bg-gray-800 border-orange-500 opacity-80"
                                                : bloqueada
                                    ...
                                    >
                                        <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-black flex-shrink-0 ${completada ? "bg-orange-500 text-white" : "bg-gray-700 text-gray-400"
                                            }`}>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-gray-500 text-xs">{leccion.concepto} · {leccion.duracion}</p>
                                        </div>
